...
const posts = [
    {
        title: '5 DVD box sets worth collecting',
        badge: 'Guide',
        author: 'Marcus Webb',
        meta: 'July 14, 2026 · 5 min read',
        text: 'Physical media is back — here are the DVD collections every film fan should own.',
        img: coverImage('DVD Collections'),
    },
];
            ...
            <section className="py-5">
                <div className="container px-4 px-md-5">
                    <div className="d-flex align-items-end justify-content-between mb-4">
                        <div>
                            <h2 className="fw-bolder mb-0">Featured products</h2>
                            <p className="text-muted mb-0">Handpicked favourites this week</p>
                        </div>
                ...
                <div className="container px-5 my-4">
                    <div className="row gx-5">
                        <div className="col-lg-4 mb-5 mb-lg-0">
                            <h2 className="fw-bolder mb-3">Why shop with us</h2>
                            <p className="text-muted mb-4">
                                Curated tech, fair prices, and support that actually helps.
                            </p>
                        ...
                        <div className="col-lg-10 col-xl-7">
                            <div className="text-center">
                                <div className="fs-4 mb-4 fst-italic">
                                    "Ordered a laptop on Monday and it arrived two days later,
                        ...
                        <div className="col-lg-8 col-xl-6">
                            <div className="text-center">
                                ...
                                <p className="lead fw-normal text-muted mb-5">
                                    Guides, reviews, and news to help you pick the right gear.
                                </p>
                            </div>
                        </div>
                    </div>
